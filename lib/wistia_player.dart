  ...
  JavascriptChannel _getJavascriptChannel() {
    return JavascriptChannel(
        ...
        onMessageReceived: (JavascriptMessage message) {
          Json jsonMessage = jsonDecode(message.message);
  ...
  String _buildWistiaHTML(WistiaPlayerController controller) {
    return '''
      ...
      <html>
        ...
        <body>
          <iframe src="//fast.wistia.net/embed/iframe/${controller.videoId}" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen oallowfullscreen msallowfullscreen width="640" height="360"></iframe>
          <script src="//fast.wistia.net/assets/external/E-v1.js" async></script>
          <script>
          window._wq = window._wq || [];
          _wq.push({ id: '${controller.videoId}', onReady: function(video) {
